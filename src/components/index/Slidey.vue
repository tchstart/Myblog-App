      ...
      <div v-if="isBlogMode" class="post">
        ...
        <div class="description">
          <div style="margin-right: 20px;">
            ...
            <span>
              {{ blogData && blogData.category && blogData.category.name ? blogData.category.name : '未分类' }}
            </span>
          </div>
...
export default {
  ...
  methods: {
    ...
    setImgLoop() {
      this.clearImgLoop()
      this.changeBg()
      this.imgLoop = setInterval(this.changeBg, 10000)
    },
    clearImgLoop() {
      if (this.imgLoop) {
